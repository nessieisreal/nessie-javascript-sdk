define('account', function (require) {
    ...
    var Account = {
		...
		/**
		  ...
		  # @Brief: Each index in the array is the object of an individual customer.
		  # @Returns an array of objects getting all the customers. 
		**/
		...
		/**
		  ...
		  # @Returns an array of objects with the accounts.
		**/
		...
		/**
		  ...
		  # @Returns a object with the account info.
		**/
		...
		/**
		  ...
		  # @Returns all accounts associated with a given customer ID as an array of objects.
		**/
