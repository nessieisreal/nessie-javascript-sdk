define('withdrawal', function (require) {
    ...
    var Withdrawal = {
		...
		getAllWithdrawalsByAccountId: function(accID) {
			var account;
			var request = $.ajax({
    ...
    updateWithdrawalById: function(accID, withdrawalID, json){
      var respCode;
      var request = $.ajax({
        url: this.urlWithEntity()+'/'+accID+'/withdrawals'
        data: {'key': this.apiKey(), 'json': json},
      ...
      return respCode;
		...
		createWithdrawal: function(toAcc, json) {
			var respCode;
			var resquest = $.ajax({
					url: this.urlWithEntity()+'/'+toAcc+'/withdrawals/',
					data: {'key': this.apiKey(), 'json': json},
					contentType: 'application/json',
					async: false,
					type: 'POST'
		...
		deleteWithdrawals: function(accID, withdrawalID)  {
			var respCode;
			var resquest = $.ajax({
					url: this.urlWithEntity()+'/'+accID+'/withdrawals/'+withdrawalID,
					data: {'key': this.apiKey()},
